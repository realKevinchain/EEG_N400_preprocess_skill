...
if exist(epochPath,'file') == 0
    ...
    fprintf(['GUI GATE D: review all 300 pooled epochs without condition ' ...
        'labels. You may use ERPLAB Simple Voltage Threshold only as a ' ...
        'candidate screen, then manually add/remove marks and click ' ...
        'UPDATE MARKS (never REJECT/delete). Save a separate review copy ' ...
        'named ' ...
        '<ID>_gateD_manual_review.set, audit EEG.reject.rejmanual and ' ...
        'related reject fields, enter the reconciled unified ' ...
