...
Treat general numerical examples as candidates that require a design rationale. For the executable 828update workflow, preserve the locked values below unless a formally documented protocol revision replaces the workflow version.
...
| 828update analysis filter | Use 0.1–30 Hz bidirectional Butterworth on EEG/EOG; do not filter TRIGGER | A different cutoff/order requires a new workflow version and distortion review | Locked study decision; contextual support `[BOOK]` PDF pp. 124, 129, 364–365 |
...
| 828update final EEG artifact flag | Use one condition-blind, manually reviewed bad-epoch list and synchronize it as bit 1 | Automated metrics may assist review but do not become separate final flags in this version | Locked study decision; visual review principles `[BOOK]` PDF pp. 196–240, 368 |
